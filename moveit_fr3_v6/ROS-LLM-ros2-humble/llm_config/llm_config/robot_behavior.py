...
robot_functions_list_1 = [
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "orientation": {
                    "type": "number",
                    "description": "The orientation of the target pose",
                },
            },
            "required": [
                "x",
    ...
    {
        "name": "publish_target_pose",
        "description": "Publish target pose message to control the movement of arm robot, including x, y, z, roll, pitch, yaw. For example,[0.2, 0.2, 0.2, 0.2] is a valid target pose.",
        "parameters": {
            "type": "object",
            "properties": {
                "x": {
                ...
                "oreintation": {
                    "type": "number",
                    "description": "The oreintaion of the target pose in radians",
                },
            },
            "required": [
                "x",
...
robot_functions_list_agv_arm = [
    {
        "name": "agv_arm_pose",
        "description": "Publish target_pose message to control the movement of Robotic Arm. This function is only compatible with robotic arm and not for any other robot.",
        "parameters": {
            "type": "object",
            "properties": {
                ...
                "w": {
                    "type": "number",
                    "description": "The oreintaion of the target pose in radians and must be in float",
                },
                "x": {
                    "type": "number",
                    "description": "The x position of the target pose",
...
class RobotBehavior:
    ...
    def __init__(self):
        self.robot_functions_list = robot_functions_list_agv_arm
